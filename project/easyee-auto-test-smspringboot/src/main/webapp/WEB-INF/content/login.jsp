...
<title>EasyEE-SM Spring Boot Login</title>
...
<script type="text/javascript" src="staticresources/easyuiex/easy.easyuiex.min-2.2.2.js"></script>
...
<body>
	<div
		...
		<h1><span style="color:#8FC31F">Easy</span><span style="color:#376E91">E</span><span style="color:#376E91">E</span>-<span style="">SM Spring Boot Platform</span></h1>
	<div class="title">
						...
						<table cellpadding="5" style="">
							...
							<tr>
								...
								<td><input class="easyui-textbox" type="password"
									...
									data-options="required:true" value="admin123"></input></td>
							</tr>
						<%--  <tr>
								<td>&nbsp;</td>
								<td>
								...
								<input class="easyui-validatebox textbox"
									...
									<div style="display: none; float: right; border: 1px solid #ccc;" id="vcTr">
										<img  title="点击切换" alt="加载中..." align="middle"
											style="cursor: pointer;" width="100" height="28" id="vcImg" src="captcha">
									</div></td>
							</tr>   
						<%--  </c:if> --%>  
							...
							<!-- <tr style="display: none;" id="vcTr">
								...
								<td>
									...
									<img alt="点击切换" style="cursor: pointer;" id="vcImg" src="captcha">
									</td>
							</tr> -->
						</table>
					</form>
